...
export function TimelineExplorer({ records }: { records: CaseRecord[] }) {
  ...
  return <>
    ...
    <section className="timeline-watch"><div><p className="kicker">Present day</p><h2>Ongoing cases</h2><p>Ongoing cases are published only when their current stage and latest event can be verified from a reliable source. No active matters are currently published.</p></div><Link href="/cases-to-watch">Open the ongoing cases tracker →</Link></section>
  </>;
}
